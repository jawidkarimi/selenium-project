...
public class T1_WebTable_Order_Verify {
    ...
    public void order_verify_name_test(){
        ...
        //bellow locator is locating me the Bob Martin's cell as where it is currently stored.
        ...
        WebElement bobsOrderDate = driver.findElement(By.xpath("//td[.= 'Bob Martin']/following-sibling::td[3]"));
