...
public class JavaFakerPractice {
    ...
    public void test1(){
        ...
        System.out.println("faker.numerify(\"619-###-####\") = " + faker.numerify("619-###-####"));
        ...
        System.out.println("faker.jawid karimi().fact() = " + faker.chuckNorris().fact().replaceAll("Chuck Norris", "Jawid Karimi"));
